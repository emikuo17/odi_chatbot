# STREAMLIT APP with RAG EXTENSION
# ✅ Adds a simple model selector (GPT / Claude / Gemini) while keeping your code structure.
# ✅ Uses OpenRouter model IDs under the hood.
# ✅ Still allows custom manual model override if you want.
...
# ✅ Model presets for your dropdown
# NOTE: These are common OpenRouter model IDs. If your OpenRouter account uses different IDs,
# just edit the strings below (no other code changes needed).
MODEL_PRESETS = {
    "GPT (OpenAI) — gpt-4o-mini": "openai/gpt-4o-mini",
    "Claude (Anthropic) — sonnet": "anthropic/claude-3.5-sonnet",
    "Gemini (Google) — 1.5 pro": "google/gemini-1.5-pro",
...
# Show confirm result (helpful UX)
